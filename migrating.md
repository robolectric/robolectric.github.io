...
Robolectric 4.0 includes support for [`androidx.test` APIs](https://developer.android.com/reference/androidx/test/packages). We strongly recommend adding `androidx.test:core:1.0.0` as a test dependency and using those APIs whenever possible rather than using Robolectric-specific APIs.
